...
CLAUDE_CONFIG_DIR="$CFG3" CODEX_HOME="$CODEX" BIN_DIR="$TMP/bin" bash "$REPO/install.sh" >/dev/null 2>&1
...
CLAUDE_CONFIG_DIR="$CFG5" CODEX_HOME="$CODEX" BIN_DIR="$TMP/bin" bash "$REPO/install.sh" >/dev/null 2>&1
rc=$?
